...
export const openApiDoc = createDocument({
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'OpenAPI documentation generated from Zod schemas and controllers',
    },
    paths: {
        '/auth/login': {
            post: {
                ...
                requestBody: {
                    content: {
                        ...
                        'application/json': {
                            schema: z.object({ email: z.string(), password: z.string() }), example: {
                                email: "oi@email.com",
                                password: "senha123",
                            }
                        },
        ...
        '/auth/register': {
            post: {
                ...
                requestBody: {
                    content: {
                        'application/json': {
                            schema: z.object({ email: z.string(), password: z.string(), name: z.string() }), example: {
                                email: "oi@email.com",
                                password: "senha123",
                                name: "Fulano de Tal"
                            }
