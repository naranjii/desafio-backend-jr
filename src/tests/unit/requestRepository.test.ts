...
describe('RequestRepository (unit)', () => {
    ...
    it('create and retrieve by id', async () => {
        ...
        const created = await RequestRepository.create({ id: 'id-1', status: 'draft' as any, userId: user.id });
    ...
    it('getAll returns array', async () => {
        ...
        await RequestRepository.create({ id: 'id-2', status: 'draft' as any, userId: user.id });
